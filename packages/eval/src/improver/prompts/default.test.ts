...
describe('defaultImproverPrompt', () => {
  ...
  describe('buildUserPrompt', () => {
    ...
    it('should include agent system prompt', () => {
      const prompt = defaultImproverPrompt.buildUserPrompt(baseContext)
    ...
    it('should include failed test details', () => {
      const failedResult = createTestResult({
        ...
        passed: false,
        verdicts: [
          { criterionId: 'accuracy', score: 45, reasoning: 'Poor accuracy', passed: false },
        ],
      })
      ...
      const prompt = defaultImproverPrompt.buildUserPrompt(context)
    ...
    it('should include all verdict details for failed cases', () => {
      const multiVerdictResult = createTestResult({
        ...
        passed: false,
        verdicts: [
          { criterionId: 'accuracy', score: 40, reasoning: 'Low accuracy', passed: false },
          { criterionId: 'consistency', score: 60, reasoning: 'Average consistency', passed: false },
        ],
      })
