  ...
  describe('buildUserPrompt', () => {
    const baseContext: JudgeContext = {
      ...
      criteria: [
        ...
        { id: 'relevance', name: 'Relevance', description: 'Evaluates relevance', weight: 2 },
      ],
    }

    it('should include agent description', () => {
      const prompt = defaultJudgePrompt.buildUserPrompt(baseContext)
    ...
    it('should handle complex nested input/output', () => {
      ...
      const prompt = defaultJudgePrompt.buildUserPrompt(complexContext)
    ...
    it('should handle empty criteria array', () => {
      ...
      const prompt = defaultJudgePrompt.buildUserPrompt(emptyContext)
    ...
    it('should include reference files when provided', () => {
      ...
      const prompt = defaultJudgePrompt.buildUserPrompt(contextWithFiles)
