...
const createMinimalAgent = () => ({
    ...
    prompt: {
        ...
        renderUserPrompt: (input: unknown) => String(input),
    },
...
describe('judgeConfigSchema', () => {
    it('should validate minimal judge config', () => {
        const config = {
            criteria: [{ id: 'accuracy', name: 'Accuracy', description: 'How accurate' }],
        };
...
describe('testCaseSchema', () => {
    ...
    it('should validate multi-turn test case', () => {
        const testCase = {
            ...
            input: { message: 'Hello' },
            multiTurn: {
                followUpInputs: [{ input: { message: 'How are you?' }, description: 'Follow-up' }],
    ...
    it('should validate multi-turn with fieldSet condition', () => {
        const testCase = {
            ...
            multiTurn: {
                terminateWhen: [{ type: 'fieldSet', fieldPath: 'booking.confirmed' }],
            },
        };
        const result = testCaseSchema.safeParse(testCase);
        expect(result.success).toBe(true);
