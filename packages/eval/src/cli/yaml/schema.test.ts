...
// ============================================================================
// validateYamlEvalFileSourceial Tests
// ============================================================================

describe('validateYamlEvalFileSourceial', () => {
    it('should return success: true for valid file', () => {
        const result = validateYamlEvalFileSourceial(minimalValidFile);
        expect(result.success).toBe(true);
    ...
    it('should return data with validated content', () => {
        const result = validateYamlEvalFileSourceial(fullValidFile);
        expect(result.success).toBe(true);
    ...
    it('should return success: false with errors for invalid file', () => {
        ...
        const result = validateYamlEvalFileSourceial(invalidFile);
        expect(result.success).toBe(false);
