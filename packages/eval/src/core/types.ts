 ...
 * @deprecated Use EvalAgent instead for clarity.
 */
export type Agent<TInput, TOutput> = EvalAgent<TInput, TOutput>

/**
 * Type alias for backwards compatibility.
 * @deprecated Use EvalAgentConfig instead for clarity.
 */
export type AgentConfig = EvalAgentConfig
...
export interface TestCase<TInput> {
   ...
   *
   * @deprecated Use FilePart in input directly for flexible file handling
   */
  files?: FileContent[]
}
 ...
 */
export interface SingleTurnResult<TInput, TOutput>
  extends TestResultWithVerdict<TInput, TOutput> {
